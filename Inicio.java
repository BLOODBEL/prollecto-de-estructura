...
public class Inicio extends javax.swing.JFrame implements ActionListener {
	...
	public Inicio() {
		...
		String[] piezas = { "Motor especial deportivo", "Motor de carga", "Carroceria", "Carroceria especial",
				"Llantas unicas de trabajo" };
		...
		JScrollPane scrollPane2 = new JScrollPane(txtAutosConstruidos);
	...
	private String buscarAuto(ListaCircular listaPiezas) {
		...
		} else if (listaPiezas.buscar("Motor de carga") && listaPiezas.buscar("Carroceria especial")
				&& listaPiezas.buscar("Llantas unicas de trabajo")) {
	...
	private void initComponents() {
		...
		JListPiezas.setModel(new javax.swing.AbstractListModel<String>() {
			String[] strings = { "Motor especial deportivo", "Motor de carga", "Carroceria", "Carroceria especial",
					"Llantas unicas de trabajo" };
	...
	public void startTimer() {
		timer = new Timer(1000, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				contadorLabel.setText(String.format("%02d:%02d:%02d", horas, minutos, segundos));
				if (minutos == 1) {
					stopTimer();
				}
